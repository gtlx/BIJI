...
export function Toolbar({ plugins, onPluginClick, onGraphClick, onOutlineClick, onExportClick, isGraphActive, isOutlineActive }: ToolbarProps) {
  ...
  return (
    <div className="toolbar">
      <div className="toolbar-items">
        ...
        <button
          className={`toolbar-btn ${isOutlineActive ? 'active' : ''}`}
